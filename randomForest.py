...
# Some code and conceptual help found at
...
testFreq = frequencies.frequencies(
    filename='https://raw.githubusercontent.com/mcvvina/HousingPrices/master/test.csv')
normTestData = normalize.normalize(
    testFreq.attributeData,
    testFreq.allPossData)
...
data_importances = [(data, round(importance, 2))
